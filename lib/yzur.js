 ...
 * ===============================================================================
 * Author: @Stefouch
 * Version: 1.0.0     for:     Foundry VTT V8 0.8.8
 * Licence: MIT
 * ===============================================================================
 * Content:
 * 
...
export class YearZeroRoll extends Roll {
  ...
  /**
   * The quantity of ones (banes) on ammo dice.
   * @type {number}
   * @readonly
   */
  get ammoBaneCount() {
  ...
  getTooltip() {
    ...
    // TODO clean this commented-out code
...
export class YearZeroDie extends Die {
  ...
  getTooltipData() {
    ...
    return {
      ...
      faces: this.faces,
      //* ==>
      //* Adds the number of dice, used by the chat's dice matrix.
      number: this.number,
