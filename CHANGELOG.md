...
- ✨ Add dice to Foundry Dice Configuration: This allows people to select manual modes for the dices used on the Year Zero Dice Roller.

## [6.0.0] - 2025-06-06

### Fixed

- Removed Foundry V13 deprecation warnings.

## [5.2.2] - 2024-07-29

### Fixed

- Removed leading operator from the dice terms.
